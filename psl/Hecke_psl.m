...
HECKE:=function(TP,DIMdata)
  ...
  PRR<X,Y,Z>:=PolynomialRing(SSS,3);  /* X,Y,Z represent f(A), f(B), f(U), coefficients are matrices */
  ...
  /* we will get the summation that defines the Hecke operator's image on A,B and U */
